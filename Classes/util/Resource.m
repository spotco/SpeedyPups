...
+(void)initialize {
	...
	all_textures = @{
		...
		TEX_UI_BONE_ICON:@"ingame_ui_bone_icon.png",
		TEX_UI_LIVES_ICON:@"ingame_ui_lives_icon.png",
		TEX_UI_TIME_ICON:@"ingame_ui_time_icon.png",
		TEX_UI_ENEMY_ALERT:@"enemy_approach_ui.png",
		TEX_UI_INGAMEUI_SS:@"ingame_ui_ss.png",
		TEX_UI_PAUSEICON:@"pauseicon.png",
		TEX_UI_STARTGAME_GO:@"GO.png",
		TEX_UI_STARTGAME_READY:@"READY.png",
